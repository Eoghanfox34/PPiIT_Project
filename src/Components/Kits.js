...
function Kits() {
    return (
        <div className="container">
            ...
            <section className="my-5">
                <h2>Shorts</h2>
                <img src="path_to_shorts_image.jpg" alt="Evolution of Soccer Shorts" className="img-fluid"/>
                <p>
            ...
            <section className="my-5">
                <h2>Socks</h2>
                <img src="path_to_socks_image.jpg" alt="Evolution of Soccer Socks" className="img-fluid"/>
                <p>
            ...
            <section className="my-5">
                ...
                <div className="row">
                    <div className="col-md-4">
                        <h3>Shin Pads</h3>
                        <img src="path_to_shinpads_image.jpg" alt="Soccer Shin Pads" className="img-fluid"/>
                        <p>
                    ...
                    <div className="col-md-4">
                        ...
                        <img src="path_to_gloves_image.jpg" alt="Goalkeeper Gloves" className="img-fluid"/>
                        <p>
                    ...
                    <div className="col-md-4">
                        <h3>Boots</h3>
                        <img src="path_to_boots_image.jpg" alt="Soccer Boots" className="img-fluid"/>
                        <p>
